...
import { IconDotsVertical, IconEdit, IconMinus, IconTrash } from "@tabler/icons-react";
...
export const ExerciseCard = ({ exercise, started, onEdit, onArchive, onDelete, onStart }: ListExerciseProps) => {
