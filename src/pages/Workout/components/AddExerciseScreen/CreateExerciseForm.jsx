...
const CreateExerciseForm = ({
  ...
  const updateExercise = (e) => {
    ...
    const currExRef = ref(
      db,
      `users/${user.data.uid}/customExercises/${editExercise.id}`
    );
    // Set to new exercise
    const updates = {};
  ...
  return (
    <CreateExerciseFormStyle
      onSubmit={(e) => (editExercise ? updateExercise(e) : createExercise(e))}
    >
      <div>
      ...
      <div>
        ...
        <div>
          <CheckboxOption>
            ...
            />
            <CheckboxLabel htmlFor="exerciseMeasure-reps">Reps</CheckboxLabel>
          </CheckboxOption>
          <CheckboxOption>
            <CheckboxInput
              type="checkbox"
          ...
          <CheckboxOption>
            ...
            />
            <CheckboxLabel htmlFor="exerciseMeasure-time">Time</CheckboxLabel>
          </CheckboxOption>
          <div
            style={{
              marginLeft: ".7rem",
