  ...
  return (
    <StyledExercise>
      <Header>
        ...
        <div className="control_container">
          {complete ? (
            ...
            <>
              {sets && (
                <ExerciseControlBtn onClick={completeExercise}>
                  +
                </ExerciseControlBtn>
              )}
              <ExerciseControlBtn onClick={removeExercise}>
                -
              </ExerciseControlBtn>
            </>
          )}
      ...
      <Body>
        {!complete && (
          <div className="control_container">
            <SetControlBtn onClick={addSet}>+</SetControlBtn>
        ...
        {sets ? (
          <div className="sets_wrapper">
            ...
            <div className="measures_container">
              {measures.map((m, j) => (
                <div key={`${name}-m-${j}-label`}>{m}</div>
              ))}
            </div>
          </div>
        ) : (
          <div className="empty_sets_message">Add sets!</div>
        )}
      </Body>
    </StyledExercise>
  );
...
const SetValueInput = ({ ...rest }) => {
  return <SetValueInputStyle type="number" {...rest} />;
};
