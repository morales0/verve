      ...
      <div className='Builder_page'>
         ...
         <div>
            <div>
               ...
               <input type='text' id='exerciseName' value={data.name} onChange={(e) => api.setName(e.target.value)} />
            </div>
            ...
            <div>
               ...
               <div>
                  <div>
                     ...
                     <label for='exerciseMuscle-quads'>
                        Quads
                     </label>
                  </div>
                  <div>
                     <input type='checkbox' id='exerciseMuscle-chest' />
                     <label for='exerciseMuscle-chest'>
                        Chest
                     </label>
                  </div>
                  <div>
                     <input type='checkbox' id='exerciseMuscle-lats' />
                     <label for='exerciseMuscle-lats'>
                        Lats
                     </label>
                  </div>
               </div>
